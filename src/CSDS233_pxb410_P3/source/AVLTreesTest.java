...
public class AVLTreesTest {
    ...
    public void insert() {
        ...
        AVLTrees<Integer, Integer> tree1 = new AVLTrees<>();
        tree1.insert(0, 2);
        tree1.insert(1, 1);
        tree1.insert(2, 4);
       ...
       AVLTrees<Integer, String> tree2 = new AVLTrees<>();
        tree2.insert(9, "a");
        tree2.insert(4, "b");
        tree2.insert(1, "c");
    ...
    public void search() {
        ...
        AVLTrees<Integer, String> tree = new AVLTrees<>();
    ...
    public void inroderRec() {
        ...
        AVLTrees<Integer, Integer> tree = new AVLTrees<>();
        tree.insert(20, 20);
        tree.insert(10, 10);
        tree.insert(1, 1);
        tree.insert(15, 15);
       ...
       AVLTrees<Integer, Integer> tree2 = new AVLTrees<>();
        tree2.insert(20, 220);
        tree2.insert(10, 210);
        tree2.insert(4, 24);
        tree2.insert(1, 21);
       ...
       AVLTrees<Integer, Integer> bst1 = new AVLTrees<>();
        bst1.insert(2, 102);
        bst1.insert(1, 101);
        bst1.insert(4, 104);
        bst1.insert(5, 105);
